      ...
      <div className="content-shell relative z-10">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-900/90 to-slate-800 p-8 sm:p-10 rounded-3xl border border-slate-800 shadow-2xl mb-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7">
            ...
            <CursorReflowText
              as="p"
              text={footerConfig.catalogDesc || "Get immediate offline access to 1,500+ CAD models, electrical schematics, and pricing for factory automation."}
              variant="body"
              ...
              <div className="flex items-center gap-3">
                ...
                {footerConfig.facebookUrl && (
                  <a
                    ...
                    aria-label="Facebook"
                    className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-blue-500 hover:border-blue-500/40 hover:bg-blue-500/10 active:scale-90 active:bg-blue-600 active:text-white transition-all duration-150"
                  >
                ...
                {footerConfig.instagramUrl && (
                  <a
                    ...
                    className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-pink-500 hover:border-pink-500/40 hover:bg-pink-500/10 active:scale-90 transition-all duration-150"
                  >
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                ...
                {/* WhatsApp */}
                <a
                  href={`https://api.whatsapp.com/send?phone=${(footerConfig.whatsappNumber || settings.support_phone).replace(/\D/g, '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp"
                  className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-emerald-500 hover:border-emerald-500/40 hover:bg-emerald-500/10 active:scale-90 transition-all duration-150"
                >
                  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                ...
                {footerConfig.youtubeUrl && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="YouTube"
                    className="w-10 h-10 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-300 hover:text-red-500 hover:border-red-500/40 hover:bg-red-500/10 active:scale-90 transition-all duration-150"
                  >
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-2 space-y-4 font-mono">
            ...
            <ul className="space-y-2.5 text-sm sm:text-base font-medium">
              {(footerConfig.usefulLinks && footerConfig.usefulLinks.length > 0
                ...
                <li key={idx}>
                  <Link href={lnk.url} className="inline-block py-1 text-slate-300 hover:text-amber-400 active:text-amber-400 active:translate-x-1.5 transition-all duration-150">
                    {lnk.label}
                  </Link>
                </li>
              ))}
            ...
            <div className="space-y-4 text-sm sm:text-base text-slate-200">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="leading-relaxed font-mono">
                  {footerConfig.addressLine1 || "Shed No : C1B-271 R - Road,"}<br />
              ...
              <div className="flex items-start gap-3 pt-1">
                ...
                <div className="space-y-1.5 font-mono">
                  <p>
                    ...
                    <a href={`tel:${settings.sub_contact_1_phone.replace(/\s+/g, '')}`} className="font-bold text-amber-400 hover:underline active:text-amber-300 inline-block transition-all duration-150">
                      {settings.sub_contact_1_phone}
                    </a>
                  </p>
                  <p>
                    {settings.sub_contact_2_name} :{" "}
                    <a href={`tel:${settings.sub_contact_2_phone.replace(/\s+/g, '')}`} className="font-bold text-amber-400 hover:underline active:text-amber-300 inline-block transition-all duration-150">
                      {settings.sub_contact_2_phone}
                    </a>
                  </p>
                  <p>
                    {settings.sub_contact_3_name} :{" "}
                    <a href={`tel:${settings.sub_contact_3_phone.replace(/\s+/g, '')}`} className="font-bold text-amber-400 hover:underline active:text-amber-300 inline-block transition-all duration-150">
              ...
              <div className="flex items-start gap-3 pt-1">
                ...
                <div className="space-y-1.5 font-mono">
                  <p>
                    <a href={`mailto:${settings.sub_email_1}`} className="text-slate-300 hover:text-amber-400 hover:underline inline-block transition-all duration-150">
                      {settings.sub_email_1}
                    </a>
                  </p>
                  <p>
                    <a href={`mailto:${settings.sub_email_2}`} className="text-slate-300 hover:text-amber-400 hover:underline inline-block transition-all duration-150">
