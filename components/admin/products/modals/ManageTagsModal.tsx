...
export function ManageTagsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 animate-in fade-in duration-150">
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-md overflow-hidden flex flex-col max-h-[85vh] text-slate-900 dark:text-white">
        {/* Header */}
        <div className="p-5 border-b border-slate-100 dark:border-slate-800 relative">
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">Manage tags: Products</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Edit, remove and create tags.</p>
        </div>
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-2 flex-1">
                      <input
                        ...
                        className="px-3 py-1 text-sm border-2 border-blue-500 bg-white dark:bg-slate-900 rounded-lg focus:outline-hidden w-full font-medium text-slate-900 dark:text-white"
                        autoFocus
                        onKeyDown={(e) => {
                      ...
                      <button
                        ...
                        className="p-1 text-blue-600 dark:text-blue-400 hover:text-blue-700 rounded-full cursor-pointer"
                      >
                    ...
                    <>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="inline-block px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg text-xs font-semibold">
                          {t.name}
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          className="p-1.5 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-full border border-blue-200 dark:border-blue-500/30 transition-colors cursor-pointer"
                          title="Edit tag"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 text-blue-600 dark:text-blue-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-full border border-blue-200 dark:border-blue-500/30 hover:border-red-200 dark:hover:border-red-500/30 transition-colors cursor-pointer"
                          title="Delete tag"
                        >
          ...
          {showCreateRow && (
            <form onSubmit={handleCreate} className="py-2.5 flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-1.5 text-sm bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500 text-slate-900 dark:text-slate-100"
                autoFocus
              />
              <button
                type="submit"
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-950/50">
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 cursor-pointer"
          >
