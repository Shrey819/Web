      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900">Save Option Setting</h2>
              <p className="text-xs text-slate-500">Save this structure to reuse across other products</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSave} className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-slate-700">Setting / Preset Name *</label>
            <input
              type="text"
              placeholder="e.g. Standard Colors & Lengths"
              value={presetName}
              onChange={(e) => setPresetName(e.target.value)}
              className="w-full px-3.5 py-2 text-sm bg-white border border-slate-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-blue-500 font-medium text-slate-900"
              autoFocus
              required
            />
          </div>
          ...
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 text-xs text-slate-600 space-y-1">
            <span className="font-semibold text-slate-800">Current configuration:</span>
          ...
          <div
            ...
            className="p-3 rounded-xl border border-slate-200 hover:border-blue-300 hover:bg-blue-50/30 transition-all cursor-pointer flex items-start gap-3"
          >
