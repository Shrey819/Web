...
import { LayoutGrid, List, SlidersHorizontal, ChevronRight, Search, RefreshCw } from "lucide-react";
      ...
      <div className="content-shell">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 pb-6 border-b border-slate-200">
          ...
          <div className="type-technical text-slate-500">
            Showing <strong className="text-slate-900 font-bold">{filteredProducts.length}</strong> active SKU items
          </div>
        </div>
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 shadow-sm space-y-4">
                ...
                <h3 className="type-card-title text-slate-900">
                  No matching industrial components found
                </h3>
                <p className="type-body-small text-slate-500 max-w-sm mx-auto">
                  Try adjusting your faceted filters, expanding the price range, or searching for broader terms like &quot;Siemens&quot; or &quot;VFD&quot;.
                </p>
                <button
